...
public class SchoolController {
    ...
    public void testTransactional(@RequestParam String schoolName) {


        schoolService.editSchool(schoolName);
//        List<School> allSchool = schoolService.querySchools(pageNum,pageSize);
//
//        for (School school : allSchool) {
//            System.out.println(school.toString());
//        }
    ...
    public void querySchoolByPage(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {

        List<School> allSchool = schoolService.querySchoolByPage(pageNum,pageSize);
    ...
    public void findSchools(@RequestParam Integer pageNum, @RequestParam Integer pageSize) {

        List<School> allSchool = schoolService.findSchools(pageNum,pageSize);
